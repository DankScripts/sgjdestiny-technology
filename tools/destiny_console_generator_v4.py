"""Generate the v4 SGU Destiny console from the selected prop reference."""
...
DIAL_IVORY = material("Destiny dial ivory", (0.72, 0.73, 0.61), 0.18, 0.42)
...
parts.extend([
    ...
    cylinder("Dial navy ring", (-1.35, -0.42, 1.50), 0.255, 0.035, DIAL,
             rotation=(math.radians(90), 0, 0), vertices=64),
    cylinder("Dial ivory annulus", (-1.35, -0.45, 1.50), 0.205, 0.035, DIAL_IVORY,
             rotation=(math.radians(90), 0, 0), vertices=64),
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT / "destiny_console_v4.blend"))
try:
    bpy.ops.wm.obj_export(filepath=str(OUT / "destiny_console_v4.obj"),
                          export_selected_objects=True, export_materials=True,
                          forward_axis="NEGATIVE_Z", up_axis="Y")
except Exception as exc:
    print("OBJ export warning:", exc)

scene.render.filepath = str(OUT / "destiny_console_v4_preview.png")
bpy.ops.render.render(write_still=True)
print("Destiny console v4 generated in", OUT)